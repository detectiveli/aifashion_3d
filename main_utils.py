...
SMPLX_PARTS = {
    ...
    'right_wrist': 'body',
    'jaw': 'body,head',
    'left_eye_smplx': 'body,head',
    'right_eye_smplx': 'body,head',
    'left_index1': 'hand',
    'left_index2': 'hand',
    'left_index3': 'hand',
    'left_middle1': 'hand',
    ...
    'right_ring': 'hand',
    'right_pinky': 'hand',
    'right_eye_brow1': 'face,head',
    'right_eye_brow2': 'face,head',
    'right_eye_brow3': 'face,head',
    'right_eye_brow4': 'face,head',
    'right_eye_brow5': 'face,head',
    'left_eye_brow5': 'face,head',
    'left_eye_brow4': 'face,head',
    'left_eye_brow3': 'face,head',
    'left_eye_brow2': 'face,head',
    'left_eye_brow1': 'face,head',
    'nose1': 'face,head',
    'nose2': 'face,head',
    'nose3': 'face,head',
    'nose4': 'face,head',
    'right_nose_2': 'face,head',
    'right_nose_1': 'face,head',
    'nose_middle': 'face,head',
    'left_nose_1': 'face,head',
    'left_nose_2': 'face,head',
    'right_eye1': 'face,head',
    'right_eye2': 'face,head',
    'right_eye3': 'face,head',
    'right_eye4': 'face,head',
    'right_eye5': 'face,head',
    'right_eye6': 'face,head',
    'left_eye4': 'face,head',
    'left_eye3': 'face,head',
    'left_eye2': 'face,head',
    'left_eye1': 'face,head',
    'left_eye6': 'face,head',
    'left_eye5': 'face,head',
    'right_mouth_1': 'face,head',
    'right_mouth_2': 'face,head',
    'right_mouth_3': 'face,head',
    'mouth_top': 'face,head',
    'left_mouth_3': 'face,head',
    'left_mouth_2': 'face,head',
    'left_mouth_1': 'face,head',
    'left_mouth_5': 'face,head',
    'left_mouth_4': 'face,head',
    'mouth_bottom': 'face,head',
    'right_mouth_4': 'face,head',
    'right_mouth_5': 'face,head',
    'right_lip_1': 'face,head',
    'right_lip_2': 'face,head',
    'lip_top': 'face,head',
    'left_lip_2': 'face,head',
    'left_lip_1': 'face,head',
    'left_lip_3': 'face,head',
    'lip_bottom': 'face,head',
    'right_lip_3': 'face,head',
    'right_contour_1': 'face,head',
    'right_contour_2': 'face,head',
    'right_contour_3': 'face,head',
    'right_contour_4': 'face,head',
    'right_contour_5': 'face,head',
    'right_contour_6': 'face,head',
    'right_contour_7': 'face,head',
    'right_contour_8': 'face,head',
    'contour_middle': 'face,head',
    'left_contour_8': 'face,head',
    'left_contour_7': 'face,head',
    'left_contour_6': 'face,head',
    'left_contour_5': 'face,head',
    'left_contour_4': 'face,head',
    'left_contour_3': 'face,head',
    'left_contour_2': 'face,head',
    'left_contour_1': 'face,head'
}
